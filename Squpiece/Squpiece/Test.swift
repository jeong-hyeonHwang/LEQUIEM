...
//        addChild(pieceBackground)
        ...
        let angle: CGFloat = CGFloat(180/(numberOfPiece))
        let rotateAngle = CGFloat(Double(2) * CGFloat.pi / Double(numberOfPiece))
        var currentAngle: CGFloat = rotateAngle
        //let donut = Donut(center: CGPoint(x: frame.midX, y: frame.midY), startAngle: 90-angle, endAngle: 90+angle, clockwise: false, radius: circleRadius, width: circleRadius - frame.width * 0.1)
        //let donut = Donut(center: CGPoint(x: frame.midX, y: frame.midY), startAngle: 0, endAngle: angle, clockwise: false, radius: circleRadius, width: circleRadius - frame.width * 0.1)
        ...
        for i in 0...lastIndex {
            ...
            piece.path = Donut(center: CGPoint(x: frame.midX, y: frame.midY), startAngle: 180, endAngle: 180 + (2 * angle), clockwise: false, radius: circleRadius, width: circleRadius - frame.width * 0.1)
            ...
            nodeNameSetting(node: piece, name: "p_\(i)")
...
//            nodeNameSetting(node: pieces[i], name: "p_\(i)")
//            //https://developer.apple.com/documentation/spritekit/sknode/getting_started_with_physics_bodies
...
//            pieces[i].addChild(pieceSprite[i])
            ...
            print("p\(i)) CURRENT ANGLE IS \(currentAngle)")
